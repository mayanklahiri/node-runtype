...
var BUILTINS = module.exports = {
  ...
  epoch_timestamp_ms: function(typeDef, typeArg, errorPrefix) {
    ...
    //
    var MIN_EPOCH_MS = 946684800000;  // January 1st, 2000
    if (typeArg < MIN_EPOCH_MS) {
      throw ErrorMessage(errorPrefix, fmt(
        'timestamp %d is in the distant past, assuming that it is coded ' +
        'in seconds instead of the required milliseconds.', typeArg));
    }
    return typeArg;
  },
